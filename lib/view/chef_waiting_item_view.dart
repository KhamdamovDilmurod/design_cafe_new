...
class ChefWaitingItemView extends StatefulWidget {
  final OrderFoodModel item;
  final VoidCallback onPressed;
  final Function() onCancelClicked;

  const ChefWaitingItemView({Key? key, required this.item, required this.onPressed, required this.onCancelClicked}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return ChefWaitingItemViewState();
  }
}

class ChefWaitingItemViewState extends State<ChefWaitingItemView> {
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceAround,
                    children: [
                      Image.asset(Assets.imagesDoubleTick, width: 24, height: 24, color: Colors.green.withOpacity(.6),),
                      Text(
                        'Tayyor',
