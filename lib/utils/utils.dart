...
showMyBottomSheet(
  ...
  return showModalBottomSheet(
    ...
    barrierColor: COLOR_GREY.withOpacity(0.8),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(message,
                              style: TextStyle(color: WHITE, fontSize: 20, fontFamily: "semibold"),
                              maxLines: 10,
                              textAlign: TextAlign.center,
                              overflow: TextOverflow.ellipsis),
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: TextButton(
                                  style: ButtonStyle(overlayColor: MaterialStateProperty.all(COLOR_PRIMARY.withOpacity(.2))),
                                  onPressed: () {
                                    if (pressOk != null) {
                                      pressOk();
                                      if (forSingOut != true) {
...
Widget showAsProgress({Color? color}) {
  ...
  return Container(
      ...
      child: Container(
        padding: EdgeInsets.all(12),
        decoration: BoxDecoration(
          boxShadow: const [BoxShadow(color: COLOR_PRIMARY, blurRadius: 150, spreadRadius: 1, blurStyle: BlurStyle.normal)],
